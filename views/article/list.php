        ...
        <div class="card-body">
            <?php if (empty($articles)): ?>
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">Commencez par ajouter votre premier article.</p>
                    <a href="/resto-campus/index.php?controller=article&action=add" class="btn btn-success">
                        <i class="fas fa-plus"></i> Ajouter un article
                    </a>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (!empty($article['ingredients'])): ?>
                                            <small><?php echo htmlspecialchars($article['ingredients']); ?></small>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <a href="/resto-campus/index.php?controller=article&action=delete&id=<?php echo $article['idArticle']; ?>"
                                               ...
                                               title="Supprimer"
                                               data-confirm-delete="Êtes-vous sûr de vouloir supprimer cet article ?">
